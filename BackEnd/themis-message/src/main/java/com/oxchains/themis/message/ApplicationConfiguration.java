...
//        http.cors().and().csrf().disable().authorizeRequests().antMatchers(HttpMethod.POST,"/login","/token","/register","/account/*", "/message/**/*").permitAll()
//                .antMatchers(HttpMethod.GET,"/verifyCode","/account/*", "/message/**/*").permitAll().antMatchers("/**/*")
//                .authenticated().and()
